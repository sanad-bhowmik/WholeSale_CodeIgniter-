...
class Permission {
    ...
    protected $module;
    protected $label;
    protected $redirect = "Admin_dashboard/login";
    protected $ci;
    ...
    public function redirect() {
        if ($this->permission) {
            ...
            echo "<div class='' style='    font-size: 40px;   text-align: center;   color: red;   margin-top: 90px; margin-left: 290px; '>You do not have permission to access. Please contact with administrator.</div>";   exit();
//            $this->ci->session->set_flashdata('error', "<div class='text-danger'>You do not have permission to access. Please contact with administrator.</div>");
