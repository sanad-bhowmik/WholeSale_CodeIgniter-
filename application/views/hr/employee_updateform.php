                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="first_name" class="form-control" type="text" placeholder="<?php echo display('first_name') ?>" id="first_name" value="<?php echo $employee_data[0]->first_name ?>" onkeyup="special_character_remove(this.value, 'first_name')">
                                <input type="hidden" name="employee_id" value="<?php echo $employee_data[0]->employee_id; ?>">
                            ...
                            <div class="col-sm-4">
                                <input name="last_name" class="form-control" type="text" placeholder="<?php echo display('last_name') ?>" id="last_name" value="<?php echo $employee_data[0]->last_name ?>" onkeyup="special_character_remove(this.value, 'last_name')">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="phone" class="form-control" type="text" placeholder="<?php echo display('phone') ?>" id="phone" value="<?php echo $employee_data[0]->phone ?>" onkeyup="onlynumber_allow(this.value, 'phone')">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <label for="hour_rate_or_salary" class="col-sm-2 col-form-div"><?php echo display('salary') ?> </label>
                            <div class="col-sm-4">
                                <input name="hrate" class="form-control" type="text" placeholder="<?php echo display('hour_rate_or_salary') ?>" id="hrate" value="<?php echo $employee_data[0]->hrate ?>"  onkeyup="onlynumber_allow(this.value, 'hrate')">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="blood_group" class="form-control select2"  id="blood_group" data-placeholder="-- select one --">
                                    <option value=""></option>
                                    <option value="a+" <?php
                                    if ($employee_data[0]->blood_group == 'a+') {
                                        echo 'selected';
                                    }
                                    ?>>A+</option>
                                    <option value="a-" <?php
                                    ...
                                    ?>>A-</option>
                                    <option value="b+" <?php
                                    if ($employee_data[0]->blood_group == 'b+') {
                                        echo 'selected';
                                    }
                                    ?>>B+</option>
                                    <option value="b-" <?php
                                    ...
                                    ?>>B-</option>
                                    <option value="ab+" <?php
                                    if ($employee_data[0]->blood_group == 'ab+') {
                                        echo 'selected';
                                    }
                                    ?>>AB+</option>
                                    <option value="ab-" <?php
                                    ...
                                    ?>>AB-</option>
                                    <option value="O+" <?php
                                    if ($employee_data[0]->blood_group == 'o+') {
                                        echo 'selected';
                                    }
                                    ?>>O+</option>
                                    <option value="O-" <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="city" class="form-control" type="text" placeholder="<?php echo display('city') ?>" id="city" value="<?php echo $employee_data[0]->city; ?>" onkeyup="special_character_remove(this.value, 'city')">

                            </div>
                            <label for="zip" class="col-sm-2 col-form-div"><?php echo display('zip') ?></label>
                            <div class="col-sm-4">
                                <input name="zip" class="form-control" type="text" placeholder="<?php echo display('zip') ?>" id="zip" value="<?php echo $employee_data[0]->zip; ?>" onkeyup="special_character_remove(this.value, 'zip')">
                            </div>
                        </div>
                        <div class="form-group row">
