                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="first_name" class="form-control" type="text" placeholder="<?php echo display('first_name') ?>" id="first_name" onkeyup="special_character_remove(this.value, 'first_name')" required>
                            </div>
                            <label for="last_name" class="col-sm-2 col-form-div"><?php echo display('last_name') ?><i class="text-danger">*</i></label>
                            <div class="col-sm-4">
                                <input name="last_name" class="form-control" type="text" placeholder="<?php echo display('last_name') ?>" id="last_name" onkeyup="special_character_remove(this.value, 'last_name')" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="designation" class="col-sm-2 col-form-div"><?php echo display('designation') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-4">
                                <?php echo form_dropdown('designation', $desig, null, 'class="form-control" ') ?>
                            </div>
...
<!--                            <label for="rate_type" class="col-sm-2 col-form-div"><?php echo display('rate_type') ?></label>
                            ...
                            <label for="salary" class="col-sm-2 col-form-div"><?php echo display('salary') ?> </label>
                            <div class="col-sm-4">
                                <input name="hrate" class="form-control" type="text" placeholder="<?php echo display('salary') ?>" onkeyup="onlynumber_allow(this.value, 'salary')" id="salary">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="city" class="form-control" type="text" placeholder="<?php echo display('city') ?>" id="city" onkeyup="special_character_remove(this.value, 'city')">

                            </div>
                            <label for="zip" class="col-sm-2 col-form-div"><?php echo display('zip') ?></label>
                            <div class="col-sm-4">
                                <input name="zip" class="form-control" type="text" placeholder="<?php echo display('zip') ?>" id="zip" onkeyup="special_character_remove(this.value, 'zip')">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-sm-2 col-form-div"><?php echo display('picture') ?></label>
                            <div class="col-sm-4">
