            ...
            <div class="col-sm-12 m-b-10">                
                ...
                if (!empty($product_id) || !empty($qr_image)) {
                    ...
                    <div  style="float: right">
                        <a  class="btn custom_btn custom_fontcolor" href="#" onclick="printDiv('printableArea')"><?php echo display('print') ?></a>
                                            ...
                                            <?php if ($counter == 5) { ?>
                                                ...
                                                <td style="border: 1px solid black ;padding: 5px">		
                                                    ...
                                                    <div class="barcode-inner" style="font-family: 'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif;text-align: center; position: relative;">
                                                        ...
                                                        <img src="<?php echo base_url('Cbarcode/barcode_generator/{product_id}') ?>" class="img-responsive center-block" alt="" style="display: block;margin-left: auto;margin-right: auto;height: 58px;width: 100%;">
