                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    if ($purchaseData) {
                                        ...
                                        <tr>
                                            ...
                                            <td class='text-center'>{purchase_cartoon}</td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3" style="text-align:right;"><b><?php echo display('total_cartoon') ?></b></td>
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:right;"><?php echo display('total_ammount') ?></th>
                                        <th class="text-right"><?php echo display('total_discount') ?></th>
                                        <th class="text-right"><?php echo display('invoice_total') ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
