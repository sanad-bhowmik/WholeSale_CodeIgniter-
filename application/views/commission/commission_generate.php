                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="customer_name" id="customer_name" tabindex="1">
                        ...
                        <div class="form-group row">
                            <label for="to" class="col-sm-3 col-form-label"><?php echo display('to') ?><i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                        ...
                        <div class="text-right form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-customer" class="btn custom_btn custom_fontcolor btn-large" name="add-customer" value="<?php echo display('generate') ?>"  tabindex="6"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo display('total_ctn') ?></th>
                                ...
                                <tbody>
                                    ...
                                    if ($product_info) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;">{per_cartoon}</td>
                                            <td style="text-align: right;">{quantity}</td>
                                            <td style="text-align: right;"><?php echo (($position == 0) ? "$currency {commission}" : "{commission} $currency") ?></td>
                                            <td style="text-align: right;"><?php echo (($position == 0) ? "$currency {total_commission_rate}" : "{total_commission_rate} $currency") ?></td>
                                        </tr>
                                        {/product_info}
                                        <?php
                                    }
                                ...
                                if ($product_info) {
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><b>{subTotalCtn}</b></td>
                                            <td><b></b></td>
                                            <td style="text-align: right;"><b>{subTotalQnty}</b></td>
                                            <td><b></b></td>
                                            <td style="text-align: right;"><b><?php echo (($position == 0) ? "$currency {subTotalComs}" : "{subTotalComs} $currency") ?></b></td>
                                        </tr>
                                    </tfoot>
                                    <?php
                                }
...
<script type="text/javascript">
    ...
    $('#customer_name').change(function (e) {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: '<?php echo base_url('Csettings/retrive_product_info') ?>',
