            ...
            <div class="col-sm-12">
                <div class="m-b-10 float_right">
                    ...
                    if ($this->permission->check_label('manage_loan')->read()->access()) {
                        ?>
                        <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Csettings/manage_loan'); ?>')" class="btn btn-warning"><?php echo display('manage_loan'); ?></a>
                    <?php } ?>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="person_id" id="name" tabindex="1" onchange="getpersoninfo(this.value)">
                        ...
                        <div class="form-group row">
                            <label for="ammount" class="col-sm-3 col-form-label text-right"><?php echo display('ammount') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="details" class="col-sm-3 col-form-label text-right"><?php echo display('details') ?> <i class="text-danger"></i></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="submit" id="add-deposit" class="btn custom_btn custom_fontcolor" name="add-deposit" value="<?php echo display('save') ?>" tabindex="7"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
