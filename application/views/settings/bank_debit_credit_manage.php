...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('bank_transection') ?></h1>
            <small><?php echo display('bank_transection') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('bank') ?></a></li>
                <li class="active"><?php echo display('bank_transection') ?></li>
            </ol>
        </div>
    </section>
            ...
            <div class="col-sm-12">
                <div class="m-b-10 float_right">
                    <?php if ($this->permission->check_label('add_new_bank')->create()->access()) { ?>
                        <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Csettings/index'); ?>')" class="btn btn-success"><?php echo display('add_new_bank'); ?></a>
                        <?php
                    }
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('bank_transection') ?> </h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Csettings/bank_debit_credit_manage_add', array('class' => 'form-vertical', 'id' => 'insert_deposit')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" placeholder="<?php echo display('description') ?>" name="description" id="description" tabindex='4'></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="withdraw_deposite_id" id="withdraw_deposite_id" required="" placeholder="<?php echo display('withdraw_deposite_id') ?>" tabindex='5'  onkeyup="special_character_remove(this.value, 'withdraw_deposite_id')"/>
                            </div>
                        </div>        
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" name="ammount" id="ammount" required="" placeholder="<?php echo display('ammount') ?>"  tabindex='6'/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="submit" id="add-deposit" class="btn custom_btn custom_fontcolor" name="add-deposit" value="<?php echo display('save') ?>"  tabindex='8'/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
