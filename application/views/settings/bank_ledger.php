...
<div class="content-wrapper removeContentwraper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-sm-12">                
<!--                <div class="m-b-10">
                    <a href="<?php echo base_url('Csettings/index'); ?>" class="btn btn-success"><?php echo display('add_new_bank'); ?></a>
                    <a href="<?php echo base_url('Csettings/bank_list'); ?>" class="btn custom_btn custom_fontcolor"><?php echo display('bank_list'); ?></a>
                </div>-->
                    ...
                    <div class="panel-heading">
                        <div class="panel-title" style="display: flex; align-content: center; justify-content: space-between;">
                            ...
                            <div style="display: flex;">
                                <button  class="btn btn-success text-right" href="#" onclick="printDiv('printableArea')"><i class="fa fa-print"></i></button>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-right"><?php echo display('debit_plus') ?></th>
                                            <th class="text-right"><?php echo display('credit_minus') ?></th>
