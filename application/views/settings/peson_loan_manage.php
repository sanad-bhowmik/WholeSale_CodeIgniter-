                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        if ($this->permission->check_label('manage_person')->read()->access()) {
                                            ?>
                                            <a href="<?php echo base_url('Csettings/person_loan_edit/{person_id}'); ?>" class="btn custom_btn custom_fontcolor btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <?php
                                        }
                                        echo form_close()
                                        ?>	
