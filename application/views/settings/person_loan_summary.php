...
<script type="text/javascript">
    function printDiv(divName) {
        ...
        document.location.href = "<?php echo base_url('Csettings/person_loan_deails/' . $person_id); ?>"
    }
</script>
<?php
$CI = & get_instance();
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div id="printableArea" style="margin-left:2px;text-align: center;">
                                ...
                                <table  class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-left"><?php echo display('details') ?></th>
                                        ...
                                        if ($ledger) {
                                            foreach ($ledger as $value) {
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php
                                                        echo $CI->occational->dateConvertMyformat($value['date']);
                                                        ?>
                                                    </td>
                                                    <td align="left"><?php echo $value['details'] ?></td>
