        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column m-b-10" style="float: right; ">
                    ...
                    <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Account_Controller') ?>')" class="btn custom_btn custom_fontcolor m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('create_account') ?></a>
                        <?php
                    }
...
//                                    foreach ($trans_category as $values) {
                            ...
                            <label for="test1" class="col-sm-2 col-form-label"><?php echo display('select_one'); ?></label>
                            <div class="col-sm-4">

                                <select name="supplier_id" id="test1" class="hidid"  style="width: 290px; height: 35px" tabindex='4'>
                                ...
                                <div id="test2" class="hidid"  style="width: 290px; height: 35px">
                                    <select name="customer_id" id="" class=""  style="width: 290px; height: 35px" tabindex='4'>
                                        <option value=""><?php echo display('select_one') ?></option>
                                        <?php if ($customer) { ?>
                                            {customer}
                                ...
                                <select name="office" id="test3" class="hidid " style="width: 290px; height: 35px" tabindex='4'>
                                    <option value=""><?php echo display('select_one') ?></option>
                                    <?php
                                    if ($account_list) {
                                        ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="" id="PaymentContainer2">
                                <label for="receipt" class="col-sm-2 col-form-label"><?php echo display('receipt_amount') ?></label>
                                <div class="col-sm-4">
