...
<div class="content-wrapper removeContentwraper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Transaction  Details Datewise</h1>
...
//                                                        }
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        $dr = $row['debit'];
                                                        echo (($position == 0) ? "$currency $dr" : "$dr $currency");
                                                        ?>
                                                    </td>
        <!--                                                    <td style="text-align: right;"><?php
//                                                        $debt += is_numeric($row['debit']);
//
...
//                                                        }
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        $credit += $row['credit'];
                                                        $cr = $row['credit'];
                                                        echo (($position == 0) ? "$currency $cr" : "$cr $currency");
                                                        ?>
                                                    </td>
        <!--                                                    <td align="right"><?php
...
//                                                        }
                                        ...
                                        <tfoot>
                                            <tr  align="right">
                                                ...
                                                <td>
                                                    <b><?php echo (($position == 0) ? "$currency $debit" : "$debit $currency"); ?></b>
                                                </td>
                                                <td>
                                                    <b><?php echo (($position == 0) ? "$currency $credit" : "$credit $currency"); ?></b>
                                                </td>
