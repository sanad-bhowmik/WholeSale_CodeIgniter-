...
<div class="content-wrapper removeContentwraper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('update_transaction'); ?></h1>
            <small><?php echo display('update_transaction'); ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('transaction'); ?></a></li>
                <li class="active"><?php echo display('update_transaction'); ?></li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column m-b-5" style="float: right; ">
                    <?php if ($this->permission->check_label('manage_transaction')->read()->access()) { ?>
                        <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Cpayment/manage_payment') ?>')" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_transaction') ?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('update_transaction'); ?></h4>
                        </div>
                        <!-- </div> -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select id="selId" class="form-control" name="transection_category" onchange="">
                                        <option>Select Option</option>
                                        <option value="1" <?php
                                        if ($transection_category == '1') {
                                            echo 'selected';
                                        } else {
                                            echo '';
                                        }
                            ...
                            <div class="form-group row">
                                <label for="dfds" class="col-sm-2 col-form-label">Select Name <i class="text-danger"></i></label>
                                <div class="col-sm-4">
                                    ...
                                    <select name="supplier_id" id="test1" class="hidid form" style="width: 290px; height: 35px">
                                        ...
                                        foreach ($supplier as $values) {
                                            ?>
                                            <option value="<?php echo $values['supplier_id']; ?>"><?php echo $values['supplier_name']; ?></option>
                                        <?php } ?>

                                        <?php
                                        foreach ($supplier_seleced as $values) {
                                            ?>
                                            <option value="<?php echo $values['supplier_id']; ?>" selected><?php echo $values['supplier_name']; ?></option>
                                        <?php } ?>
                                    </select>
                                    ...
                                    <div id="test4" class="hidid"  style="width: 290px; height: 35px">
                                        ...
                                        <input id="loan_id" class="loan_hidden_value" type="hidden" name="loan_id" value="<?php
                                        if ($transection_category == 4) {
                                            echo $relation_id;
                                        };
                                        ?>">
                                    ...
                                    <select name="office" id="test3" class="hidid " style="width: 290px; height: 35px">
                                        ...
                                        <?php
                                        foreach ($office_selected as $values) {
                                            ?>
                                            <option value="<?php echo $values['account_name']; ?>" selected><?php echo $values['account_name']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <div id="test5" class="hidid"  style="width: 290px; height: 35px">
                                        <select name="employee_id" id="" class="form-control select2" data-placeholder="<?php echo display('employee_name') ?>"  style="width: 290px; height: 35px" tabindex='5'>
                                            <option value=""></option>
                                            <?php if ($get_employee) { ?>
                                                <?php foreach ($get_employee as $employee) { ?>
                                                    <option value="<?php echo $employee->employee_id; ?>" <?php
                                                    if ($relation_id == $employee->employee_id) {
                                                        echo 'selected';
                                                    }
                                                    ?>>
                            ...
                            <div class="form-group row" id="PaymentContainer1"> 
                                ...
                                <div class="col-sm-4">
                                    <input class="none form-control emt_payment" name ="pay_amount" id="school" type="number" placeholder="Payment Amount" value="{pay_amount}" ></div>
                            </div>

                            <div class="form-group row" id="PaymentContainer2"> 
                                <label for="first_name" class="col-sm-2 col-form-label">Recipt Amount</label>
                                <div class="col-sm-4">
                                    <input class="none form-control emt_receipt" name ="amount" id="school" type="number" placeholder="Recipt Amount" value="{amount}"></div>
                            </div>
                            <div class="form-group row"> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="submit" id="update-transaction" class="btn custom_btn custom_fontcolor btn-large" name="add-Account" value="<?php echo display('save_changes') ?>" />
                                </div>
                            </div>
                        </div>
                        <?php echo form_close() ?>
