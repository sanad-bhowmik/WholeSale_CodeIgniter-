...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Todays Details</h1>
            <small>Todays Details</small>
            <ol class="breadcrumb">
                                ...
                                <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Transetions</th>
                                                ...
                                                <tr>
                                                    <td  align="center">
                                                        <a href="" data-toggle="modal" data-target="#myModal" 
                                                           ...
                                                           onclick="javascript:report_popup(<?php echo $row['transection_category']; ?>)" ><?php echo $row['account_name'] ?></a></td>
                                                    <td align="right">
