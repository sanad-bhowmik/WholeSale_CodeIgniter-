            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="selId" class="col-sm-2 col-form-label"><?php echo display('transaction_categry') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-4">
                                <select id="selId" class="form-control" name="transection_category" tabindex='3'>
                                    ...
                                    <option value="5"><?php echo display('employee') ?></option>
                                    <?php
//                                foreach($trans_category as $values){
                            ...
                            <label for="test1" class="col-sm-2 col-form-label">Select Option Name</label>
                            <div class="col-sm-4">

                                <select name="supplier_id" id="test1" class="hidid" data-placeholder="<?php echo display('select_supplier'); ?>"  style="width: 290px; height: 35px"  tabindex='4'>
                                ...
                                <div id="test2" class="hidid"  style="width: 290px; height: 35px">
                                    <select name="customer_id" id="" class="form-control select2" data-placeholder="<?php echo display('customer_name'); ?>"  style="width: 290px; height: 35px" tabindex='4'>
                                        <option value=""><?php echo display('select_one') ?></option>
                                        <?php if ($customer) { ?>
                                            {customer}
                                ...
                                <select name="office" id="test3" class="hidid select2" style="width: 290px; height: 35px" tabindex='4'>
                                    <option value=""><?php echo display('select_one') ?></option>
                                    <?php
                                    if ($account_list) {
                                        ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select onchange="bank_info_show(this)" name="payment_type" id="Transection_mood" class="form-control select2"  tabindex='5'>
                            ...
                            <div class="" id="PaymentContainer1"> 
                                <label for="payment" class="col-sm-2 col-form-label"><?php echo display('payment_amount') ?></label>
                                <div class="col-sm-4">
                                    <input class="none form-control " name ="pay_amount" id="payment" class="none" type="number" placeholder="Payment Amount"  tabindex='6'></div>
                            </div>
                        ...
                        <div id="bank_info_hide">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="bank_name" id="bank_name"  class="form-control select2" style="width: 100%" tabindex='10'>
                                        <?php if ($bank) { ?>
                                            {bank}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2" style="margin-top:5px ">
                                <input type="submit" id="add-customer" class="btn custom_btn custom_fontcolor btn-large text-right" name="add-employee" value="<?php echo display('submit') ?>"  tabindex='11'/>
                            </div>
                        </div>
...
//            alert(selectId);
            ...
            if (selectId == "Supplier") {
                ...
                $("#test3").show();
            } else if (selectId == "Loan") {//alert(selectId);
                $("#test4").show();
