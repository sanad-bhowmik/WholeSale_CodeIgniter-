    ...
    <section class="content">
        ...
        <div class="col-sm-12">
            <div class="m-b-10" style="float: right;"> 
                <a href="javascript:void(0)" onclick="pageopen('<?= base_url('Language/phrase') ?>')" class="btn custom_btn custom_fontcolor">Add Phrase</a>
            </div>
        </div>
        </div>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <?= form_open('language/addlanguage', ' class="form-inline" ') ?> 
                                                ...
                                                <button type="submit" class="btn custom_btn custom_fontcolor">Save</button>
                                            <?= form_close(); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <?php if (!empty($languages)) {?>
                                        ...
                                        <tr>
                                            <td><?= $sl++ ?></td>
                                            <td><?= $language ?></td>
                                            <td><a href="<?= base_url("Language/editPhrase/$key") ?>" class="btn btn-xs custom_btn custom_fontcolor"><i class="fa fa-edit"></i></a>  
                                            </td> 
                                        </tr>
                                        <?php } ?>
                                    <?php } ?>
