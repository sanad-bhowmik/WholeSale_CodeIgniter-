        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="m-b-10" style="float: right;">
                    <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('User/manage_user'); ?>')" class="btn custom_btn custom_fontcolor"><?php echo display('manage_user'); ?></a>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="1" class="form-control" name="first_name" id="first_name" placeholder="<?php echo display('first_name') ?>" onkeyup="special_character_remove(this.value, 'first_name')" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="2" class="form-control" name="last_name" id="last_name" placeholder="<?php echo display('last_name') ?>" onkeyup="special_character_remove(this.value, 'last_name')" required />
                            </div>
                        </div>
...
<!--                        <div class="form-group row">
                            <label for="user_type" class="col-sm-3 col-form-label text-right"><?php echo display('user_type') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-customer" class="btn custom_btn custom_fontcolor btn-large" name="add-user" value="<?php echo display('save') ?>"  tabindex="6"/>
