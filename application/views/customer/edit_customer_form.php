                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="customer_name" id="customer_name" type="text" placeholder="<?php echo display('customer_name') ?>"  required="" value="{customer_name}" tabindex='1' onkeyup="special_character_remove(this.value, 'customer_name')">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="mobile" value="{customer_mobile}" id="mobile" type="text" placeholder="<?php echo display('customer_mobile') ?>" min="0" tabindex='3' onkeyup="onlynumber_allow(this.value,'mobile')">
                            </div>
                        </div>
