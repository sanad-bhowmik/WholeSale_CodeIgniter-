            ...
            <div class="col-sm-12">
                <div class="m-b-10 float_right">
                    ...
                    if ($this->permission->check_label('credit_customer')->read()->access()) {
                        ?>
                        <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Ccustomer/credit_customer'); ?>')" class="btn btn-warning"><?php echo display('credit_customer'); ?></a>
                    <?php } ?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default collapse" id="collapseExample">
                    <div class="panel-body"> 
                        <form action="<?php echo base_url('Ccustomer/paid_customer_search_item') ?>" class="form-inline" method="post" accept-charset="utf-8">
...
//                                            $balance = $customer['customer_balance'];
                                            if ($balance <= 0) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <?php echo (($position == 0) ? "$currency $balance" : "$balance $currency"); ?>
                                                    </td>
...
<!--                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="text-align:right !Important">
                                            <b><?php
                                if ($subtotal) {
                                    echo (($position == 0) ? "$currency {subtotal}" : "{subtotal} $currency");
                                }
                                ?></b>
                                        </td>
                                        <td></td>
        ...
        if (x == true) {
            $.ajax
                    ({
                        ...
                        {
                            pageopen('<?php // echo base_url('Ccustomer/paid_customer');  ?>');
                        }
                    });
        }
    });
