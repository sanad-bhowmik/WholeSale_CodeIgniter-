        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="m-b-10 float_right">
                    <?php if ($this->permission->check_label('add_customer')->read()->access()) { ?>
                ...
                <div class="panel panel-default collapse" id="collapseExample">
                    <div class="panel-body"> 
                        ...
                        <form action="<?php echo base_url('Ccustomer/customer_search_item') ?>" class="form-inline" method="post" accept-charset="utf-8">
                            ...
                            <select class="form-control m-r-15" name="customer_id">
                                {all_customer_list}
...
//                                                    echo '<pre>';  print_r($result); 
                                        ...
                                        <center>
                                            ...
                                            if ($this->permission->check_label('manage_customer')->update()->access()) {
                                                ?>
                                                <a href="<?php echo base_url() . 'Ccustomer/customer_update_form/' . $single['customer_id']; ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                <?php
                                            }
                                            if ($this->permission->check_label('manage_customer')->delete()->access()) {
                                                ?>
                                                <a href="javascript:void(0)" class="deleteCustomer btn btn-danger btn-sm" name="<?php echo $single['customer_id']; ?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                <?php
                                            }
                                            echo form_close()
                                            ?>
...
//                        {
//                             pageopen('<?php echo base_url('Ccustomer/manage_customer'); ?>');
//                        }
//                    });
//        }
//    });
