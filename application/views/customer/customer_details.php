                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title printbtn">
                            <h4><?php echo display('customer_information') ?></h4>
                            <div>
                                <a  class="btn btn-success" href="#" onclick="printDiv('printableArea')" data-toggle="tooltip" data-placement='top' title="<?php echo display('print'); ?>"><i class="fa fa-print text-white"></i></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left"><?php echo display('receipt_no') ?></th>
