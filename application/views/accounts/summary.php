            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('Caccounts/summary_datewise', array('class' => 'form-inline', 'id' => 'summary_datewise')) ?>
                        <?php $today = date('Y-m-d'); ?>

                        <label class="select"><?php echo display('search_by_date') ?>: <?php echo display('from') ?></label>
                        <input type="text" name="from_date"  value="<?php echo $today; ?>" data-date-format="yyyy-mm-dd" class="datepicker form-control" required/>

                        <label class="select"><?php echo display('to') ?></label>
                        <input type="text" name="to_date" data-date-format="yyyy-mm-dd" value="<?php echo $today; ?>" class="datepicker form-control" required/>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3"><b><?php echo display('total_inflow_ammount') ?></b></td>
                                        <td><b><?php echo (($position == 0) ? "$currency {total_inflow}" : "{total_inflow} $currency") ?></b></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3"><b><?php echo display('total_outflow_ammount') ?></b></td>
                                        <td><b><?php echo (($position == 0) ? "$currency {total_outflow}" : "{total_outflow} $currency") ?></b></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
