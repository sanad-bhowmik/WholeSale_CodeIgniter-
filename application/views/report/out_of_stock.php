...
<div class="content-wrapper removeContentwraper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    <?php // if ($this->permission->method('stock_report_sp_wise', 'read')->access()) { ?>
                    <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Creport/stock_report_supplier_wise') ?>')" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('stock_report_supplier_wise') ?> </a>
                    <?php //} ?>
                    <?php // if ($this->permission->method('stock_report_pro_wise', 'read')->access()) { ?>
                    <a href="javascript:void(0)" onclick="pageopen('<?php echo base_url('Creport/stock_report_product_wise') ?>')" class="btn custom_btn custom_fontcolor m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('stock_report_product_wise') ?> </a>
                    <?php //} ?> 
                </div>
            </div>
        </div>
