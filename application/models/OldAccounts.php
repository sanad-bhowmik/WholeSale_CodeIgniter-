...
class Accounts extends CI_Model {
  ...
  //customer_ledger ENTRY
    ...
    {
        $result = $this->db->insert('customer_ledger',$data); 
        if ($result) {
          return true;
        }
  }
 ...
 // supplier_ledger Entry
  ...
  {
      $result = $this->db->insert('supplier_ledger',$data);  
      if ($result) {
        return true;
      } 
  ...
  {
      $result = $this->db->insert($account_table,$data);
      if ($result) {
        return true;
      }
  }
  ...
  public function accounts_closing_data()
  {
        ...
        return array(
                ...
                "bank_balance"      =>number_format($balance, 2, '.', ','),
            );
  }
  ...
  public function cheque_manager($perpage,$page)
  {
    $this->db->select(' * ');
  ...
  public function get_closing_report($perpage,$page)
  {
