...
//    ========= its for get employee ==========
    ...
    // Employee Edit data
    public function employee_editdata($employee_id) {
        $this->db->select('*');
    ...
    public function headcode() {
        $query = $this->db->query("SELECT MAX(HeadCode) as HeadCode FROM acc_coa WHERE HeadLevel='3' And HeadCode LIKE '502040%'");
        return $query->row();
    }
...
//   =========== its for single_employee ================
    public function single_employee($employee_id) {
        $this->db->select('a.*,b.designation');
        $this->db->from('employee_history a');
        $this->db->join('designation b', 'a.designation = b.id');
    ...
    public function employee_ledgerinfo($employee_id) {
        $query = $this->db->select('*')
                ->from('employee_ledger a')
