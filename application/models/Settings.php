...
class Settings extends CI_Model {
    ...
    public function loan_list_personal($per_page, $limit) {
        ...
        $this->db->join('pesonal_loan_information  b', 'a.person_id=b.person_id', 'left');
//        $this->db->select("a.*");
//        $this->db->from('pesonal_loan_information a');
        $this->db->limit($per_page, $limit);
    ...
    public function personledger_search_by_date($person_id, $from_date, $to_date) {
...
// update loan Person
    ...
    // commission generating all product 
    public function product_info_all() {
