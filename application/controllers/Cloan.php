...
class Cloan extends CI_Controller {
    ...
    public function add1_person() {
        $this->permission->check_label('add_office_person')->create()->redirect();
...
//        $this->template->full_admin_html_view($content);
    ...
    public function manage1_person($carry = null) {
        $this->permission->check_label('manage_office_loan')->create()->redirect();
        #        #pagination starts        #
