...
class Company_setup extends CI_Controller {
    ...
    public function manage_company($carry = null) {
        $this->permission->check_label('manage_company')->create()->redirect();
        $config = array();
        $config["base_url"] = base_url() . "Company_setup/manage_company/1";
    ...
    public function company_update() {
        ...
        redirect(base_url('Company_setup/manage_company/1'));
    }
