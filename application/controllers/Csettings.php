...
//        $this->template->full_admin_html_view($content);
    ...
    public function add_new_bank() {
        ...
        redirect(base_url('Csettings/bank_list/1'));
        exit;
    }

    public function bank_transaction($carry = null) {
        $this->permission->check_label('bank_transection')->create()->redirect();
    ...
    public function add_person() {
        $this->permission->check_label('add_person')->create()->redirect();
...
//        $this->template->full_admin_html_view($content);
    ...
    public function submit_person() {
        ...
        if ($result) {
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('Csettings/manage_person/1'));
        } else {
    ...
    //office loan search by phone number
    public function officeloan_phone_search_by_name() {
        $person_id = $this->input->post('person_id');
        $result = $this->db->select('person_phone')
                ->from('person_information')
                ->where('person_id', $person_id)
    ...
    public function add_loan($carry = null) {
        $this->permission->check_label('add_loan')->create()->redirect();
    ...
    public function submit_loan() {
        ...
        if ($result) {
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('Csettings/add_loan/1'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('Csettings/add_loan/1'));
        }
    ...
    public function add_payment($carry = null) {
        $this->permission->check_label('add_payment')->create()->redirect();
    ...
    public function submit_payment() {
        ...
        if ($result) {
            $this->session->set_userdata(array('message' => display('successfully_added')));
            redirect(base_url('Csettings/add_payment/1'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('Csettings/add_payment/1'));
        }
    ...
    public function manage_person($carry = null) {
        $this->permission->check_label('manage_person')->create()->redirect();
        #        #pagination starts        #
        $config["base_url"] = base_url('Csettings/manage_person/1');
    ...
    public function manage_loan($carry = null) {
        $this->permission->check_label('manage_loan')->create()->redirect();
        #        #pagination starts        #
    ...
    public function update_person($person_id) {
        ...
        if ($result) {
            ...
            redirect(base_url('Cloan/manage1_person/1'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('Cloan/manage1_person/1'));
        }
    ...
    public function update_loan($person_id) {
        ...
        if ($result) {
            $this->session->set_userdata(array('message' => display('successfully_updated')));
            redirect(base_url('Csettings/manage_loan/1'));
        } else {
            $this->session->set_userdata(array('error_message' => display('not_added')));
            redirect(base_url('Csettings/manage_loan/1'));
        }
    ...
    public function bank_list($carry = null) {
        $this->permission->check_label('manage_bank')->create()->redirect();
    ...
    public function update_bank($bank_id) {
        ...
        $this->session->set_userdata(array('message' => display('successfully_updated')));
        redirect('Csettings/bank_list/1');
    }
